...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--src-dir", default="datasets/grasp-tools/source/graspall")
    parser.add_argument("--background-dir", default="datasets/grasp-tools/source/backgrounds")
